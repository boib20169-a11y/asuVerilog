...
REM
REM Generated by Vivado on Sat May 16 15:58:50 -0400 2026
...
echo "xvlog --incr --relax -prj studentNumber_tb_vlog.prj"
call xvlog  --incr --relax -prj studentNumber_tb_vlog.prj -log xvlog.log
