...
REM
REM Generated by Vivado on Sat May 16 13:01:45 -0400 2026
...
echo "xvlog --incr --relax -prj studentID_tb_vlog.prj"
call xvlog  --incr --relax -prj studentID_tb_vlog.prj -log xvlog.log
